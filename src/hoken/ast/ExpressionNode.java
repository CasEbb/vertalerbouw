		...
		if(this.getChildCount() == 1) {
			...
			case HokenChecker.MINUS:
				if(E.type != Type.INTEGER) {
					throw new HokenException(this, "Foute operand voor unaire " + HokenChecker.tokenNames[operand] + ". Toegestaan is INTEGER, gevonden is " + E.type.toString());
				}
				this.type = Type.INTEGER;
				break;
			case HokenChecker.NOT:
				if(E.type != Type.BOOLEAN) {
					throw new HokenException(this, "Foute operand voor unaire " + HokenChecker.tokenNames[operand] + ". Toegestaan is BOOLEAN, gevonden is " + E.type.toString());
				}
			...
			case HokenChecker.MINUS:
				if(L.type != Type.INTEGER || R.type != Type.INTEGER) {
					throw new HokenException(this, "Foute operands voor " + HokenChecker.tokenNames[operand] + ". Toegestaan is [INTEGER, INTEGER], gevonden is [" + L.type.toString() + "," + R.type.toString() + "]");
				}
				this.type = Type.INTEGER;
				break;
			// int x int => bool
			...
			case HokenChecker.NEQ:
				if(L.type != R.type || L.type == Type.VOID || R.type == Type.VOID) {
					throw new HokenException(this, "Foute operands voor " + HokenChecker.tokenNames[operand] + ". Types moeten matchen en mogen geen VOID zijn, gevonden is [" + L.type.toString() + "," + R.type.toString() + "]");
				}
				this.type = Type.BOOLEAN;
				break;
			// bool x bool => bool
			...
			case HokenChecker.OR:
				if(L.type != Type.BOOLEAN || R.type != Type.BOOLEAN) {
					throw new HokenException(this, "Foute operands voor " + HokenChecker.tokenNames[operand] + ". Toegestaan is [BOOLEAN, BOOLEAN], gevonden is [" + L.type.toString() + "," + R.type.toString() + "]");
				}
				this.type = Type.BOOLEAN;
				break;
			}
